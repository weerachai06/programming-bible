...
interface ContentVisibilityListProps {
  itemCount?: number;
}
    ...
    <div className="p-4">
          ...
          {items.map((item) => (
            <div
              ...
              style={{
                ...
                containIntrinsicSize: "1px 120px", // Estimated size for layout stability
              }}
            >
      ...
      <div className="mt-4 p-3 bg-gray-50 rounded-lg">
        <p className="text-sm text-gray-600">
          <strong>CSS Properties Used:</strong>
        </p>
        <ul className="text-sm text-gray-600 mt-2 space-y-1">
          <li>
            ...
            - Skips layout/paint for off-screen elements
          </li>
          <li>
            •{" "}
            <code className="bg-gray-200 px-1 rounded">
